...
Please set up the directory structure, create the schema file (AGENTS.md), and walk me through ingesting my first source document. 


change the following according to your own needs:

"""
The initial directory structure can be as simple as possible, the idea is that as long as the structure can satisfy my needs it is OK. My needs for a research project is that: I need a wiki page that summarizes the overview of the project: 
1. record the user's current understanding of the project: 
	- Real world problem: what the real world problem the project is trying to solve. 
	- Research Questions: what are the research questions? 
	- Problem Formulation(Modeling for the problem) 
	- Baseline methods Proposed Mehtod. 
	- Experiment Design: what experiments you are going to do to verify your proposed method. 
	- Initially these knowledge about the project(Real world problem, Research Questions, ...) can be blank. As my knowledge grows and my practical experience (test the method on real world data) grows, I may require the LLM agent to update the overview of the project (reflecting my updated knowledge of the project). 
2. record the current status of the project: 
	- what is doing currently.
	- what needs to be done next.
	- the mile stones achieved.
3. Because this page is meant to be read by the user, the content of this wiki page should be concise and with links(obsidian style) to other revevant wiki pages or raw files. 
