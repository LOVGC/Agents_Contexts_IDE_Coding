...
## Prompts
- [[raw/summary_prompts.md]]: Chapter-summary prompt that asks for key points, support, relationships, and final takeaways. Note: [[wiki/items/chapter-summary-prompt]]
- [[raw/learning unfamiliar topics prompts.md]]: Prompt framework for learning an unfamiliar topic by extracting expert mental models, points of disagreement, and depth-testing questions. Note: [[wiki/items/learning-unfamiliar-topics-prompt-framework]]
- [[raw/llm_wiki.md]]: Template prompt for initializing a personal LLM wiki knowledge base to organize collected prompts, contexts, debugger configs, and setup snippets. Note: [[wiki/items/llm-wiki-bootstrap-template]]
- [[raw/llm_wiki_stem_cell.md]]: Idea file for an adaptive LLM wiki where the agent maintains knowledge and periodically evolves the schema as understanding deepens. Note: [[wiki/items/llm-wiki-developmental-system]]
...
## Project Setup
- [[raw/use_uv.md]]: Project environment rule that standardizes Python work on `uv`, `uv add`, and `uv run`. Note: [[wiki/items/uv-project-environment-rule]]
- [[raw/uv_pytomal.toml]]: Example `uv` project configuration that shows dependencies, a CUDA PyTorch index, and a dev dependency group. Note: [[wiki/items/uv-project-config-example]]
